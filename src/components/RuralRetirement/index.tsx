...
import rural_aposentadoria from "public/rural-aposentadoria.jpg"
import rural from "public/rural.jpg"

const RuralRetirement = () => {
    ...
    <main>
      ...
      <div className="relative min-h-screen flex items-center justify-center" id="home">
        <Image
          ...
          width={501}
          height={902}
          src={rural_aposentadoria}
          alt="Aposentadoria rural benefício campo agricultor"
          placeholder="blur"
        ...
        <div className="relative z-40 text-center p-4 bg-[#f2ebd191] rounded-lg flex flex-col justify-center items-center">
          <h1 className={`font-[600] text-[#012B09] text-[42px] md:text-[44px] 2xl:text-[60px] ${montaguSlab.className} leading-[60px] mb-4`}>
            Procurando Advogado Especialista em Aposentadoria Rural?
          </h1>
...
font-bold [&:hover>*]:!text-white hover:!animate-bg-darken-dark-green [&:hover>*]:!animate-bg-darken-dark-green  mt-6 items-center"
      ...
      >
              <Image
  src={rural}
  alt="agricultor aposentado benefício INSS"
  fill
...
/>
        ...
        <div className="container mx-auto flex flex-col gap-[40px] justify-center items-center pb-[48px] px-[20px] lg:px-[42px] relative z-10">
          <h3 className={`font-[500] ${montaguSlab.className} text-[42px] 2xl:text-[60px] pt-[64px] text-center text-white`}>
            Advogado para Aposentadoria especial do Trabalhador Rural
          </h3>
          ...
          <button
            className="animate-bg-white-to-green py-2 px-6 w-auto rounded-md flex text-base md:text-lg text-stone-800 font-bold
            [&:hover>*]:!text-white hover:!animate-bg-darken-dark-green [&:hover>*]:!animate-bg-darken-dark-green  mt-6 items-center"
            onClick={handleClick}
          >
            <IoLogoWhatsapp alignmentBaseline="central" size={24} className="mr-2" />
            FALE CONOSCO
...
export default RuralRetirement;

...
layout: post
permalink: /blog/doencas-estigmatizantes-no-aspecto-previdenciario/
...
<div className="moldura">
  <div className="video">
    <LiteYouTubeEmbed webp id="jxbFMjRa1J4" adNetwork playlist={false} title="Um Erro do INSS que Poderia ter custado caro para uma Funcionária Pública" noCookie />
  </div>
</div>

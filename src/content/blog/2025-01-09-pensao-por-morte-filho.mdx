...
layout: post
permalink: /blog/pensao-por-morte-para-o-filho-que-ainda-nao-nasceu/
...
<div className="moldura">
  <div className="video">
    <LiteYouTubeEmbed webp id="_KcjSsxDU6c" adNetwork playlist={false} title="Pensão por Morte para Filho Não Nascido" noCookie />
  </div>
</div>

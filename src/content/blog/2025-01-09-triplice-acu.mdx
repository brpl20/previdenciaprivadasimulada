...
layout: post
permalink: /blog/tripla-acumulacao-de-beneficio/
...
<div className="moldura">
  <div className="video">
    <LiteYouTubeEmbed webp id="CXLdYQXx1DI" adNetwork playlist={false}  title="Teses da Tríplice Acumulação na mira do TCU" noCookie />
  </div>
</div>
